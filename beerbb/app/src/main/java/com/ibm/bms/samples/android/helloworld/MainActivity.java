...
public class MainActivity extends Activity implements ResponseListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView buttonText = (TextView) findViewById(R.id.log_in_button);

        try {
            //initialize SDK with IBM Bluemix application ID and route
            //TODO: Please replace <APPLICATION_ROUTE> with a valid ApplicationRoute and <APPLICATION_ID> with a valid ApplicationId
            BMSClient.getInstance().initialize(this, "http://beerb.mybluemix.net", "b65065ad-01d4-46db-93f8-468a1c2486b9");
        }
    ...
    private void setStatus(final String messageText, boolean wasSuccessful){
        ...
        final TextView buttonText = (TextView) findViewById(R.id.log_in_button);
